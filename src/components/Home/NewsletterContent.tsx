    ...
    >
      ...
      <div>
        <Heading className="text-3xl md:text-4xl font-bold mb-4">
          Stay Connected with the World of Books
        </Heading>
        <Paragraph className="text-base md:text-lg leading-relaxed">
          Subscribe to our newsletter to receive book recommendations, author updates, 
          early access to new releases, and exclusive discounts on your favorite titles.
        </Paragraph>
      </div>
      ...
      <form className="flex flex-col space-y-4">
        ...
        <div className="flex items-center space-x-2">
          ...
          <label htmlFor="subscribe" className="text-sm">
            Yes, send me book updates and newsletters.
          </label>
        </div>
